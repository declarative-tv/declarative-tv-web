-- | We use datetimes all over the place in Fpers to describe when a resource like a comment
...
-- | representation.
module Fpers.Data.PreciseDateTime where
...
-- | Display a human-readable version of the precise datetime, as described in the Fpers spec
-- |
