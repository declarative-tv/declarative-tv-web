-- | The favorite buttons in Fpers don't have enough encapsulated state or behaviors to be a full
...
-- |
-- | For a more in-depth example of this pattern, see the `Fpers.Component.Part.FollowButton`
-- | module.
module Fpers.Component.Part.FavoriteButton
  ( ButtonSize(..)
  , favoriteButton
  , favorite
  , unfavorite
...
import Fpers.Capability.Resource.Article (class ManageArticle, favoriteArticle, unfavoriteArticle)
