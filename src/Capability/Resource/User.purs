...
-- | any application code besides the application monad, `Fpers.AppM`. In addition, we can test
...
module Fpers.Capability.Resource.User where

import Prelude

import Fpers.Api.Request (LoginFields, RegisterFields)
import Fpers.Data.Email (Email)
import Fpers.Data.Profile (Profile, ProfileRep, ProfileWithEmail, Author)
...
-- | `Fpers.Data.Profile` module for more details.
